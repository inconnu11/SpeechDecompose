...
exp_name="CONTENT_STYLE_SPK_0922_VQ_KL_PLOT_mel_energy_pitch_sampling_22050_vocoder_top30_3mel_autoencoder_v7"    # experimental name (e.g., Evan/Guy/Jessa)
...
python third_party_new_0922/Submitter/utils/amlt_submit.py \
		...
		--run-cmd "python -u train_ddp_dataloader_segment_submit.py"
